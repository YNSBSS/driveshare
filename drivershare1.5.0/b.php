            ...
            if (!preg_match("/^[a-zA-Z0-9._%+-]+@gmail\.com$/", $email)) {
             ...
             if (($email== 'admin@gmail.com') && ($mot_de_passe=='admin')) {
                ...
                if (mysqli_num_rows($result) < 1) {
                  ...
                  $req_email = "SELECT * FROM users WHERE email_user = ?";
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    if (($mot_de_passe == $row["mot_de_passe"])) {
                        ...
                        echo 
                        ' <div >
                               <form action="demandertrajet.html" method="post">
                                   <div> <h3>Bienvenue monsieur ' . $row["nom_prenom"] . ' </h3></div>
                                   <br>
                                   <br>
                     ...
                     else 
                        {
                          echo '<form action="authentification.html" method="post">
                                <div> votre mot de passe est incorrect ! monsieur ' . $row["nom_prenom"] .' </h3></div>
                                <br>
                                <br>
                                </h3> Appuyez sur button choisir essayé nouveau mot de passe</h3>
                                <br>
                                <br>
